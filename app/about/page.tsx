...
import Home from '../api/hello/components/Home'
import Instructors from '../api/hello/components/Instructor'
import { RevealList, RevealWrapper } from 'next-reveal'

export default function page() {
  return (
    <>
      <Home title='About' src='https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/bb73bc48-dc10-450a-9236-15285a9883d2/db6ob9o-4755e8bf-e9f3-400e-91b4-cddfe6865ba4.png/v1/fill/w_1600,h_844,strp/luxury_office___visual_novel_bg_by_doodle_space_db6ob9o-fullview.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..vPRAVCbp8zrfoRW9MW9g4GV77ijjubqtdNC1bgxotCw' />
      <Box>
        <Container maxW={1400}>
          ...
          <Flex my='50px' px={{ lg: '50px', base: '20px' }} gap='30px' display={{ lg: 'flex', base: 'grid' }}>
            ...
            <Box flexBasis='50%' m='auto'>
              <RevealWrapper origin='right' delay={200} duration={1000} distance='500px' reset={true}>
                <Image mx='auto' src='/panaverse.png' alt='President' width={{ lg: 450, base: 200 }} height={{ lg: 280, base: 150 }} />
              </RevealWrapper>
            </Box>
          </Flex>
        </Container>
