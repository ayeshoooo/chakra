...
export default function Banner() {
    return (
        <>
            <Box bgAttachment='fixed' bgImage='https://wallpaperaccess.com/full/1879531.jpg' >
                <RevealWrapper origin='left' delay={200} duration={3000} distance='500px' reset={true}>
                    <Container maxW={1400}>
                        <Flex pt={{ lg: '150px', base: '30px' }} pb={{ lg: '100px', base: '0' }} px={{ lg: '40px', base: '5px' }} display={{ lg: 'flex', base: 'grid' }}>
                            <Box flexBasis={{ lg: '50%', base: '%' }} px={{ lg: '40px', base: '0' }}marginLeft='15px'>
                                <Heading color='black' size='2xl'>Prepare yourself for the Next Generation of Internet with Panaverse</Heading>
                                <Text pt='10px'color='gray'>One Year Panaverse DAO Earn as you Learn Program. Consolidating Web 3.0, Metaverse, Artificial Intelligence (AI), Cloud, Edge, and Ambient Computing/IoT Technologies</Text>
                                <Button mt='20px' size='lg' colorScheme='teal'>More Info</Button>
                            </Box>
                            <Box mt={{ lg: '-80px', base: '0' }} flexBasis='50%'>
                                <Image src='/logo2.webp' alt="Panaverse" width={{ lg: '700', base: '400' }} height={{ lg: '400', base: '300px' }} loading="lazy" decoding="async" data-nimg="1" className="img" />
                            </Box>
                        </Flex>
                    ...
                    <Flex gap={{ lg: '100px', base: '10px' }} display={{ lg: 'flex', base: 'grid' }}>
                        <Box flexBasis='50%'>
                            <RevealWrapper origin='left' delay={200} duration={1000} distance='500px' reset={true}>
                                <Image src='/logo2.webp' alt="Panaverse" width={{ lg: '700', base: '100' }} height={{ lg: '400', base: '200' }}marginLeft='12px' />
                            </RevealWrapper>
                        </Box>
                        <Box flexBasis='50%' pt={{ lg: '80px', base: '10px' }} px={{ lg: '0', base: '5px' }}>
                            <RevealWrapper origin='right' delay={200} duration={1000} distance='500px' reset={true}>
                                <Heading size='2xl'marginLeft='12px'>Program Of Studies</Heading>
                                <Text pr={{ lg: '50px', base: "25px" }} pt='10px'marginLeft='12px'>This curriculum is intended for beginners who want to learn software development from the ground up. It is going to be a fifteen-month-long hybrid program that includes both onsite and online classes and is divided into five quarters of 13 weeks each. The emphasis will be on hands-on learning by educating students to produce projects.</Text>
                                <Button mt='10px' size='lg' colorScheme='teal'marginLeft='12px'>Read More</Button>
                            </RevealWrapper>
                        </Box>
                    </Flex>
                </Container>
